...
if __name__ == '__main__':  # Точка входа при запуске этого скрипта
    ...
    secCodes = ('SiH3', 'RIH3', 'CRH3', 'VBH3', 'SRH3', 'GZH3', 'POH3', 'GKH3', 'SPH3', 'PZH3', 'ALH3',
                'LKH3', 'YNH3', 'MNH3', 'MMH3')  # Формат фьючерса: <Тикер><Месяц экспирации><Последняя цифра года> Месяц экспирации: 3-H, 6-M, 9-U, 12-Z
    ...
    SaveCandlesToFile(classCode, secCodes, 'M', 60, skipFirstDate=True, skipLastDate=True)  # 60-и минутные бары
    ...
    SaveCandlesToFile(classCode, secCodes, 'M', 1, skipFirstDate=True, skipLastDate=True)  # 1-и минутные бары
